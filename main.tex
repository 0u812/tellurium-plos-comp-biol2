...
In order to address the requirement of broad standards compliance, we tested Tellurium against a set of example simulation encodings provided by the SED--ML Web Tools \cite{bergmann2017sed}. These examples utilize advanced features of the SED--ML standard, and are designed to demonstrate the standard's coverage of different types of analysis. Table \ref{swt-examples} lists all files used in this test set, and Fig \ref{fig:swt-roundtrip} shows the results of exporting these files to Tellurium and back again.
